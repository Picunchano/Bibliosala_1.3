...
class TutorialWindow(ctk.CTkToplevel):
    ...
    def _insert_text(self, textbox, text, heading=False):
        ...
        # Habilitar para insertar, luego deshabilitar para hacerlo de solo lectura
    ...
    def _populate_nueva_reserva_tab(self, tab):
        ...
        self._insert_text(textbox, "2.  Ingresa el RUT del alumno. Si el alumno ya está registrado, sus datos (nombre, apellido, etc.) se cargarán automáticamente. Si no, deberás completar los campos.\n\n")
        self._insert_text(textbox, "3.  Selecciona la sala deseada de la lista desplegable.\n\n")
        self._insert_text(textbox, "4.  Ajusta la fecha, hora de inicio y hora de fin de la reserva. Por defecto, el sistema sugiere la fecha actual y un rango de una hora.\n\n")
